    ...
    string? Today)
{
    ...
    public string? ItemType =>
        PropertyType.StartsWith("ImmutableArray<", StringComparison.Ordinal) ? PropertyType[15..^1] : null;
    ...
    {
        ListShape.Nodes => Type["SyntaxList<".Length..^1],
        ListShape.Separated => Type["SeparatedSyntaxList<".Length..^1],
        _ => null,
    };

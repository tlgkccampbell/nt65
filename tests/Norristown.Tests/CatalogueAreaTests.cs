...
public sealed class CatalogueAreaTests
{
    ...
    [
        ...
        [
            ...
            "declared-in-another-module", "define-redeclared", "defined-asks-about-defines", "export-ambiguous",
            "export-narrows-address-size", "family-declares-too-much", "family-member-collides",
            "family-misplaced", "family-not-over-an-enum", "ident-parameter-declared", "label-in-data",
        ...
        [
            ...
            "select-arguments", "select-condition-is-text", "select-condition-not-constant",
            "setting-not-exported", "setting-unknown", "shift-count-out-of-range", "sizeof-depends-on-alignment",
            "sizeof-depends-on-expansion", "sqrt-of-a-negative", "strcat-not-a-byte", "strsub-out-of-range",
            "target-argument", "turn-or-scale-out-of-range",
        ]),
        ("Macros",
        [
        ...
        [
            ...
            "operand-in-another-space", "outside-every-segment", "padding-outside-a-routine",
            "segment-attribute-not-constant", "segment-attribute-out-of-range", "segment-attribute-twice",
            "segment-block-redundant", "segment-declared-twice", "segment-dp-not-zp", "segment-mirror-invalid",
            "segment-mirrors-need-a-bank", "segment-standard-size", "segment-undeclared", "space-not-a-name",
        ...
        [
            ...
            "routine-runs-off-the-end", "runs-into-data", "self-modifying-unchecked",
        ...
        [
            ...
            "configuration-not-an-object", "configuration-unknown", "define-name-invalid", "define-not-a-number",
            "diagnostic-name-unknown", "diagnostic-not-turned-down", "diagnostic-severity-unknown",
            "project-cpu-unknown", "project-json-invalid", "project-key-unknown", "project-not-a-list",
            "project-not-a-string", "project-not-an-object", "project-segment-key-unknown",
            "project-segment-not-an-object", "project-segment-size-missing", "project-space-holds-unknown",
            "project-value-not-an-object", "range-invalid", "ranges-overlap",
        ]),
        ("Signatures",
        [
            ...
            "macro-noreturn", "noreturn-declares-an-exit", "signature-item-twice", "signature-set-not-a-set",

...
/// <summary>
/// Tests the suggestion on a line longer than the editor's setting, which marks the brackets the
/// line-breaking refactoring would lay out.
/// </summary>
public sealed class LongLineTests
{
    ...
    [Fact]
    public void ALongLineIsSuggestedAtItsFirstBracketsThatBreak()
    {
        ...
        Assert.Equal(Long.IndexOf('(', StringComparison.Ordinal) + 1, hint.Range.Start.Character);
    }
    ...
    [InlineData("X = .select(1111111111, 2222222222, 3333333333, 4444444444,\n    5)\n", 40)]

...
/// <summary>
/// The text of one diagnostic, and the catalogue entry it is reported under. A reporting site
/// names a descriptor and passes it the arguments for its format; a descriptor whose format has
/// no placeholders converts implicitly to its message, so a site can pass the descriptor itself.
/// </summary>
...
{
    /// <summary>The message of a descriptor whose format takes no arguments.</summary>

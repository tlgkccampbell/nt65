...
internal readonly record struct Resolution(Symbol? Symbol, string? Module = null, bool IsAlias = false, string? From = null)
{
    /// <summary>Gets the resolution for a name that means nothing and has already been reported.</summary>
    public static Resolution Reported => default;
    ...
    /// <summary>
    /// Gets this resolution as the <see cref="SymbolInfo"/> given to a consumer, which carries only the

...
/// <summary>
/// One segment of the program (§5.2): its name and the address size every symbol in it
/// gets. A segment is declared exactly once, so this is what §7.2 sizes references from.
/// </summary>

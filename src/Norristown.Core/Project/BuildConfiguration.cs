...
/// <c>pal</c>. A configuration gives setting values over the project's own, and says where its output
/// goes.
/// </summary>
/// <param name="Name">The name that <c>--config</c> and the editor's setting use for the configuration.</param>
/// <param name="SettingValues">Values for settings that add to the project's, or override them by name.</param>
...
public sealed record BuildConfiguration(string Name, IReadOnlyList<SettingValue> SettingValues, string? Out, Span Declaration)
{
    /// <summary>
